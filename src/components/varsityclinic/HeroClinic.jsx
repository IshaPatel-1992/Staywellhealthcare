...
export default function HeroClinic() {
  // ✅ keep your slides, index, mounted, prev/next, useEffects
  ...
  return (
    ...
    <section id="home" className="group relative h-[92vh] md:h-[96vh] pt-24 md:pt-28 overflow-hidden">
      {/* your slider code exactly */}
